...
class RecoveryController extends Controller
{
    ...
    public function sendPasswordMail(Request $request) {
        ...
        if ($user) {
            ...
            return response()->json(["message" => 'На вашу почту отправлено сведение о восстановлении доступа, пожалуйста, проверьте указанную почту (обратите внимание, в некоторых случаях письмо может оказаться в Спам-папке). В целях безопасности, повторный запрос на эту почту вы можете сделать через 30 мин.'], 200);
        }
    }
}
